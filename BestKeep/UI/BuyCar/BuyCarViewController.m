...
- (void)getDataWithRequest
{
    ...
    [BKService GetShoppingCartAmontOfgoods:^(id obj) {
        NSString* dataString = obj;
        if ([[NSString stringWithFormat:@"%@",dataString] intValue] > 0) {
            self.title = [NSString stringWithFormat:@"购物车(%@)",dataString];
...
-(void)shoopCartList{
    ...
    [BKService GetShoppingCartList:^(id obj){
...
-(void)changeOrderWithArray:(NSMutableArray *)orderArr{
   ...
   // NSDictionary * data = @{paramsStr:@"data"};
    ...
    [BKService editShoppingCartGoods:nil data:data callback:^(id obj) {
    
    }];

}
#pragma mark - 删除购物车商品
-(void)deleteToSaveWuthOrderArr:(NSMutableArray *)orderArr{
    ...
    if (orderArray.count > 0) {
        ...
        [BKService deleteShoppingCartGoods:^(id obj) {
...
-(void)moveToSaveWithOrderArr:(NSArray *)orderArr{
    ...
    if (orderArray.count > 0) {
        NSString * orderStr = [orderArray componentsJoinedByString:@","];
        __weak typeof(self)wSelf = self;
        [BKService addGoodsToCollect:orderStr view:nil callback:^(id obj) {
...
-(void)footerAccountView:(footerAccountView *)footerAccountView deleteButtonClicked:(UIButton *)deleteButton{
    [self deleteToSaveWuthOrderArr:[self getSelectedOrder]];
    NSLog(@"删除");
}
-(void)footerAccountView:(footerAccountView *)footerAccountView calculateButtonClicked:(UIButton *)calculateButton{
    ...
    if (selectedOrder.count != 0) {
        ...
        //[global_Array addObject:list1.global_status];
        for (ShoppingCarList *SC in selectedOrder) {
            ...
            //            [dic1 setObject:SC.goods_pro_rel1 forKey:@"goods_pro_rel1"];
            //            [dic1 setObject:SC.goods_pro_rel2 forKey:@"goods_pro_rel2"];
            //            [dic1 setObject:SC.goods_pro_rel3 forKey:@"goods_pro_rel3"];
            //            [dic1 setObject:SC.goods_pro_rel3 forKey:@"goods_pro_rel4"];
            //            [dic1 setObject:SC.goods_pro_rel3 forKey:@"goods_pro_rel5"];
